...
(function($) {
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $scrubberbox = $('<div class="sc-scrubber-box"></div>').appendTo($player),
        $scrubber = $('<div class="sc-scrubber"></div>').appendTo($scrubberbox),
        ...
        $player
          .find('.sc-controls')
            .append('<a href="#play" class="sc-play"><i class="fa fa-play"></i></a> <a href="#pause" class="sc-pause hidden"><i class="fa fa-pause"></i></a>')
          .end()
